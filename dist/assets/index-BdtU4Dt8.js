 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ve(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Gh(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(ve())}function Qh(){var n;const e=(n=ri())===null||n===void 0?void 0:n.forceEnvironment;if(e==="node")return!0;if(e==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function Jh(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function Qc(){const n=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof n=="object"&&n.id!==void 0}function Yh(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Xh(){const n=ve();return n.indexOf("MSIE ")>=0||n.indexOf("Trident/")>=0}function Zh(){return!Qh()&&!!navigator.userAgent&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")}function Jc(){try{return typeof indexedDB=="object"}catch{return!1}}function Yc(){return new Promise((n,e)=>{try{let t=!0;const r="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(r);i.onsuccess=()=>{i.result.close(),t||self.indexedDB.deleteDatabase(r),n(!0)},i.onupgradeneeded=()=>{t=!1},i.onerror=()=>{var o;e(((o=i.error)===null||o===void 0?void 0:o.message)||"")}}catch(t){e(t)}})}function ed(){return!(typeof navigator>"u"||!navigator.cookieEnabled)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var sl,xn,ol,Nr,hs,al,cl,ll;(function(){var n,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(s,c,u){return s==Array.prototype||s==Object.prototype||(s[c]=u.value),s};function t(s){s=[typeof globalThis=="object"&&globalThis,s,typeof window=="object"&&window,typeof self=="object"&&self,typeof br=="object"&&br];for(var c=0;c<s.length;++c){var u=s[c];if(u&&u.Math==Math)return u}throw Error("Cannot find global object")}var r=t(this);function i(s,c){if(c)e:{var u=r;s=s.split(".");for(var f=0;f<s.length-1;f++){var T=s[f];if(!(T in u))break e;u=u[T]}s=s[s.length-1],f=u[s],c=c(f),c!=f&&c!=null&&e(u,s,{configurable:!0,writable:!0,value:c})}}function o(s,c){s instanceof String&&(s+="");var u=0,f=!1,T={next:function(){if(!f&&u<s.length){var A=u++;return{value:c(A,s[A]),done:!1}}return f=!0,{done:!0,value:void 0}}};return T[Symbol.iterator]=function(){return T},T}i("Array.prototype.values",function(s){return s||function(){return o(this,function(c,u){return u})}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var a=a||{},l=this||self;function h(s){var c=typeof s;return c=c!="object"?c:s?Array.isArray(s)?"array":c:"null",c=="array"||c=="object"&&typeof s.length=="number"}function d(s){var c=typeof s;return c=="object"&&s!=null||c=="function"}function p(s,c,u){return s.call.apply(s.bind,arguments)}function w(s,c,u){if(!s)throw Error();if(2<arguments.length){var f=Array.prototype.slice.call(arguments,2);return function(){var T=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(T,f),s.apply(c,T)}}return function(){return s.apply(c,arguments)}}function R(s,c,u){return R=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?p:w,R.apply(null,arguments)}function C(s,c){var u=Array.prototype.slice.call(arguments,1);return function(){var f=u.slice();return f.push.apply(f,arguments),s.apply(this,f)}}function D(s,c){function u(){}u.prototype=c.prototype,s.aa=c.prototype,s.prototype=new u,s.prototype.constructor=s,s.Qb=function(f,T,A){for(var b=Array(arguments.length-2),G=2;G<arguments.length;G++)b[G-2]=arguments[G];return c.prototype[T].apply(f,b)}}function L(s){const c=s.length;if(0<c){const u=Array(c);for(let f=0;f<c;f++)u[f]=s[f];return u}return[]}function k(s,c){for(let u=1;u<arguments.length;u++){const f=arguments[u];if(h(f)){const T=s.length||0,A=f.length||0;s.length=T+A;for(let b=0;b<A;b++)s[T+b]=f[b]}else s.push(f)}}class z{constructor(c,u){this.i=c,this.j=u,this.h=0,this.g=null}get(){let c;return 0<this.h?(this.h--,c=this.g,this.g=c.next,c.next=null):c=this.i(),c}}function q(s){return/^[\s\xa0]*$/.test(s)}function W(){var s=l.navigator;return s&&(s=s.userAgent)?s:""}function X(s){return X[" "](s),s}X[" "]=function(){};var Ie=W().indexOf("Gecko")!=-1&&!(W().toLowerCase().indexOf("webkit")!=-1&&W().indexOf("Edge")==-1)&&!(W().indexOf("Trident")!=-1||W().indexOf("MSIE")!=-1)&&W().indexOf("Edge")==-1;function J(s,c,u){for(const f in s)c.call(u,s[f],f,s)}function E(s,c){for(const u in s)c.call(void 0,s[u],u,s)}function g(s){const c={};for(const u in s)c[u]=s[u];return c}const _="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function v(s,c){let u,f;for(let T=1;T<arguments.length;T++){f=arguments[T];for(u in f)s[u]=f[u];for(let A=0;A<_.length;A++)u=_[A],Object.prototype.hasOwnProperty.call(f,u)&&(s[u]=f[u])}}function y(s){var c=1;s=s.split(":");const u=[];for(;0<c&&s.length;)u.push(s.shift()),c--;return s.length&&u.push(s.join(":")),u}function I(s){l.setTimeout(()=>{throw s},0)}function m(){var s=cr;let c=null;return s.g&&(c=s.g,s.g=s.g.next,s.g||(s.h=null),c.next=null),c}class ae{constructor(){this.h=this.g=null}add(c,u){const f=vt.get();f.set(c,u),this.h?this.h.next=f:this.g=f,this.h=f}}var vt=new z(()=>new Ti,s=>s.reset());class Ti{constructor(){this.next=this.g=this.h=null}set(c,u){this.h=c,this.g=u,this.next=null}reset(){this.next=this.g=this.h=null}}let It,Et=!1,cr=new ae,lr=()=>{const s=l.Promise.resolve(void 0);It=()=>{s.then(_n)}};var _n=()=>{for(var s;s=m();){try{s.h.call(s.g)}catch(u){I(u)}var c=vt;c.j(s),100>c.h&&(c.h++,s.next=c.g,c.g=s)}Et=!1};function ke(){this.s=this.s,this.C=this.C}ke.prototype.s=!1,ke.prototype.ma=function(){this.s||(this.s=!0,this.N())},ke.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function se(s,c){this.type=s,this.g=this.target=c,this.defaultPrevented=!1}se.prototype.h=function(){this.defaultPrevented=!0};var ur=function(){if(!l.addEventListener||!Object.defineProperty)return!1;var s=!1,c=Object.defineProperty({},"passive",{get:function(){s=!0}});try{const u=()=>{};l.addEventListener("test",u,c),l.removeEventListener("test",u,c)}catch{}return s}();function Xe(s,c){if(se.call(this,s?s.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,s){var u=this.type=s.type,f=s.changedTouches&&s.changedTouches.length?s.changedTouches[0]:null;if(this.target=s.target||s.srcElement,this.g=c,c=s.relatedTarget){if(Ie){e:{try{X(c.nodeName);var T=!0;break e}catch{}T=!1}T||(c=null)}}else u=="mouseover"?c=s.fromElement:u=="mouseout"&&(c=s.toElement);this.relatedTarget=c,f?(this.clientX=f.clientX!==void 0?f.clientX:f.pageX,this.clientY=f.clientY!==void 0?f.clientY:f.pageY,this.screenX=f.screenX||0,this.screenY=f.screenY||0):(this.clientX=s.clientX!==void 0?s.clientX:s.pageX,this.clientY=s.clientY!==void 0?s.clientY:s.pageY,this.screenX=s.screenX||0,this.screenY=s.screenY||0),this.button=s.button,this.key=s.key||"",this.ctrlKey=s.ctrlKey,this.altKey=s.altKey,this.shiftKey=s.shiftKey,this.metaKey=s.metaKey,this.pointerId=s.pointerId||0,this.pointerType=typeof s.pointerType=="string"?s.pointerType:hr[s.pointerType]||"",this.state=s.state,this.i=s,s.defaultPrevented&&Xe.aa.h.call(this)}}D(Xe,se);var hr={2:"touch",3:"pen",4:"mouse"};Xe.prototype.h=function(){Xe.aa.h.call(this);var s=this.i;s.preventDefault?s.preventDefault():s.returnValue=!1};var Tt="closure_listenable_"+(1e6*Math.random()|0),yn=0;function vn(s,c,u,f,T){this.listener=s,this.proxy=null,this.src=c,this.type=u,this.capture=!!f,this.ha=T,this.key=++yn,this.da=this.fa=!1}function wt(s){s.da=!0,s.listener=null,s.proxy=null,s.src=null,s.ha=null}function At(s){this.src=s,this.g={},this.h=0}At.prototype.add=function(s,c,u,f,T){var A=s.toString();s=this.g[A],s||(s=this.g[A]=[],this.h++);var b=In(s,c,f,T);return-1<b?(c=s[b],u||(c.fa=!1)):(c=new vn(c,this.src,A,!!f,T),c.fa=u,s.push(c)),c};function Ze(s,c){var u=c.type;if(u in s.g){var f=s.g[u],T=Array.prototype.indexOf.call(f,c,void 0),A;(A=0<=T)&&Array.prototype.splice.call(f,T,1),A&&(wt(c),s.g[u].length==0&&(delete s.g[u],s.h--))}}function In(s,c,u,f){for(var T=0;T<s.length;++T){var A=s[T];if(!A.da&&A.listener==c&&A.capture==!!u&&A.ha==f)return T}return-1}var wi="closure_lm_"+(1e6*Math.random()|0),Ai={};function yo(s,c,u,f,T){if(Array.isArray(c)){for(var A=0;A<c.length;A++)yo(s,c[A],u,f,T);return null}return u=Eo(u),s&&s[Tt]?s.K(c,u,d(f)?!!f.capture:!1,T):lh(s,c,u,!1,f,T)}function lh(s,c,u,f,T,A){if(!c)throw Error("Invalid event type");var b=d(T)?!!T.capture:!!T,G=Ci(s);if(G||(s[wi]=G=new At(s)),u=G.add(c,u,f,b,A),u.proxy)return u;if(f=uh(),u.proxy=f,f.src=s,f.listener=u,s.addEventListener)ur||(T=b),T===void 0&&(T=!1),s.addEventListener(c.toString(),f,T);else if(s.attachEvent)s.attachEvent(Io(c.toString()),f);else if(s.addListener&&s.removeListener)s.addListener(f);else throw Error("addEventListener and attachEvent are unavailable.");return u}function uh(){function s(u){return c.call(s.src,s.listener,u)}const c=hh;return s}function vo(s,c,u,f,T){if(Array.isArray(c))for(var A=0;A<c.length;A++)vo(s,c[A],u,f,T);else f=d(f)?!!f.capture:!!f,u=Eo(u),s&&s[Tt]?(s=s.i,c=String(c).toString(),c in s.g&&(A=s.g[c],u=In(A,u,f,T),-1<u&&(wt(A[u]),Array.prototype.splice.call(A,u,1),A.length==0&&(delete s.g[c],s.h--)))):s&&(s=Ci(s))&&(c=s.g[c.toString()],s=-1,c&&(s=In(c,u,f,T)),(u=-1<s?c[s]:null)&&Ri(u))}function Ri(s){if(typeof s!="number"&&s&&!s.da){var c=s.src;if(c&&c[Tt])Ze(c.i,s);else{var u=s.type,f=s.proxy;c.removeEventListener?c.removeEventListener(u,f,s.capture):c.detachEvent?c.detachEvent(Io(u),f):c.addListener&&c.removeListener&&c.removeListener(f),(u=Ci(c))?(Ze(u,s),u.h==0&&(u.src=null,c[wi]=null)):wt(s)}}}function Io(s){return s in Ai?Ai[s]:Ai[s]="on"+s}function hh(s,c){if(s.da)s=!0;else{c=new Xe(c,this);var u=s.listener,f=s.ha||s.src;s.fa&&Ri(s),s=u.call(f,c)}return s}function Ci(s){return s=s[wi],s instanceof At?s:null}var Si="__closure_events_fn_"+(1e9*Math.random()>>>0);function Eo(s){return typeof s=="function"?s:(s[Si]||(s[Si]=function(c){return s.handleEvent(c)}),s[Si])}function fe(){ke.call(this),this.i=new At(this),this.M=this,this.F=null}D(fe,ke),fe.prototype[Tt]=!0,fe.prototype.removeEventListener=function(s,c,u,f){vo(this,s,c,u,f)};function Ee(s,c){var u,f=s.F;if(f)for(u=[];f;f=f.F)u.push(f);if(s=s.M,f=c.type||c,typeof c=="string")c=new se(c,s);else if(c instanceof se)c.target=c.target||s;else{var T=c;c=new se(f,s),v(c,T)}if(T=!0,u)for(var A=u.length-1;0<=A;A--){var b=c.g=u[A];T=dr(b,f,!0,c)&&T}if(b=c.g=s,T=dr(b,f,!0,c)&&T,T=dr(b,f,!1,c)&&T,u)for(A=0;A<u.length;A++)b=c.g=u[A],T=dr(b,f,!1,c)&&T}fe.prototype.N=function(){if(fe.aa.N.call(this),this.i){var s=this.i,c;for(c in s.g){for(var u=s.g[c],f=0;f<u.length;f++)wt(u[f]);delete s.g[c],s.h--}}this.F=null},fe.prototype.K=function(s,c,u,f){return this.i.add(String(s),c,!1,u,f)},fe.prototype.L=function(s,c,u,f){return this.i.add(String(s),c,!0,u,f)};function dr(s,c,u,f){if(c=s.i.g[String(c)],!c)return!0;c=c.concat();for(var T=!0,A=0;A<c.length;++A){var b=c[A];if(b&&!b.da&&b.capture==u){var G=b.listener,le=b.ha||b.src;b.fa&&Ze(s.i,b),T=G.call(le,f)!==!1&&T}}return T&&!f.defaultPrevented}function To(s,c,u){if(typeof s=="function")u&&(s=R(s,u));else if(s&&typeof s.handleEvent=="function")s=R(s.handleEvent,s);else throw Error("Invalid listener argument");return 2147483647<Number(c)?-1:l.setTimeout(s,c||0)}function wo(s){s.g=To(()=>{s.g=null,s.i&&(s.i=!1,wo(s))},s.l);const c=s.h;s.h=null,s.m.apply(null,c)}class dh extends ke{constructor(c,u){super(),this.m=c,this.l=u,this.h=null,this.i=!1,this.g=null}j(c){this.h=arguments,this.g?this.i=!0:wo(this)}N(){super.N(),this.g&&(l.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function En(s){ke.call(this),this.h=s,this.g={}}D(En,ke);var Ao=[];function Ro(s){J(s.g,function(c,u){this.g.hasOwnProperty(u)&&Ri(c)},s),s.g={}}En.prototype.N=function(){En.aa.N.call(this),Ro(this)},En.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var bi=l.JSON.stringify,fh=l.JSON.parse,ph=class{stringify(s){return l.JSON.stringify(s,void 0)}parse(s){return l.JSON.parse(s,void 0)}};function Pi(){}Pi.prototype.h=null;function Co(s){return s.h||(s.h=s.i())}function So(){}var Tn={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function ki(){se.call(this,"d")}D(ki,se);function Di(){se.call(this,"c")}D(Di,se);var Rt={},bo=null;function fr(){return bo=bo||new fe}Rt.La="serverreachability";function Po(s){se.call(this,Rt.La,s)}D(Po,se);function wn(s){const c=fr();Ee(c,new Po(c))}Rt.STAT_EVENT="statevent";function ko(s,c){se.call(this,Rt.STAT_EVENT,s),this.stat=c}D(ko,se);function Te(s){const c=fr();Ee(c,new ko(c,s))}Rt.Ma="timingevent";function Do(s,c){se.call(this,Rt.Ma,s),this.size=c}D(Do,se);function An(s,c){if(typeof s!="function")throw Error("Fn must not be null and must be a function");return l.setTimeout(function(){s()},c)}function Rn(){this.g=!0}Rn.prototype.xa=function(){this.g=!1};function gh(s,c,u,f,T,A){s.info(function(){if(s.g)if(A)for(var b="",G=A.split("&"),le=0;le<G.length;le++){var K=G[le].split("=");if(1<K.length){var pe=K[0];K=K[1];var ge=pe.split("_");b=2<=ge.length&&ge[1]=="type"?b+(pe+"="+K+"&"):b+(pe+"=redacted&")}}else b=null;else b=A;return"XMLHTTP REQ ("+f+") [attempt "+T+"]: "+c+`
`+u+`
`+b})}function mh(s,c,u,f,T,A,b){s.info(function(){return"XMLHTTP RESP ("+f+") [ attempt "+T+"]: "+c+`
`+u+`
`+A+" "+b})}function Kt(s,c,u,f){s.info(function(){return"XMLHTTP TEXT ("+c+"): "+yh(s,u)+(f?" "+f:"")})}function _h(s,c){s.info(function(){return"TIMEOUT: "+c})}Rn.prototype.info=function(){};function yh(s,c){if(!s.g)return c;if(!c)return null;try{var u=JSON.parse(c);if(u){for(s=0;s<u.length;s++)if(Array.isArray(u[s])){var f=u[s];if(!(2>f.length)){var T=f[1];if(Array.isArray(T)&&!(1>T.length)){var A=T[0];if(A!="noop"&&A!="stop"&&A!="close")for(var b=1;b<T.length;b++)T[b]=""}}}}return bi(u)}catch{return c}}var pr={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},Oo={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},Oi;function gr(){}D(gr,Pi),gr.prototype.g=function(){return new XMLHttpRequest},gr.prototype.i=function(){return{}},Oi=new gr;function et(s,c,u,f){this.j=s,this.i=c,this.l=u,this.R=f||1,this.U=new En(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new Vo}function Vo(){this.i=null,this.g="",this.h=!1}var No={},Vi={};function Ni(s,c,u){s.L=1,s.v=vr(je(c)),s.m=u,s.P=!0,Lo(s,null)}function Lo(s,c){s.F=Date.now(),mr(s),s.A=je(s.v);var u=s.A,f=s.R;Array.isArray(f)||(f=[String(f)]),Qo(u.i,"t",f),s.C=0,u=s.j.J,s.h=new Vo,s.g=fa(s.j,u?c:null,!s.m),0<s.O&&(s.M=new dh(R(s.Y,s,s.g),s.O)),c=s.U,u=s.g,f=s.ca;var T="readystatechange";Array.isArray(T)||(T&&(Ao[0]=T.toString()),T=Ao);for(var A=0;A<T.length;A++){var b=yo(u,T[A],f||c.handleEvent,!1,c.h||c);if(!b)break;c.g[b.key]=b}c=s.H?g(s.H):{},s.m?(s.u||(s.u="POST"),c["Content-Type"]="application/x-www-form-urlencoded",s.g.ea(s.A,s.u,s.m,c)):(s.u="GET",s.g.ea(s.A,s.u,null,c)),wn(),gh(s.i,s.u,s.A,s.l,s.R,s.m)}et.prototype.ca=function(s){s=s.target;const c=this.M;c&&qe(s)==3?c.j():this.Y(s)},et.prototype.Y=function(s){try{if(s==this.g)e:{const ge=qe(this.g);var c=this.g.Ba();const Wt=this.g.Z();if(!(3>ge)&&(ge!=3||this.g&&(this.h.h||this.g.oa()||na(this.g)))){this.J||ge!=4||c==7||(c==8||0>=Wt?wn(3):wn(2)),Li(this);var u=this.g.Z();this.X=u;t:if(Mo(this)){var f=na(this.g);s="";var T=f.length,A=qe(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){Ct(this),Cn(this);var b="";break t}this.h.i=new l.TextDecoder}for(c=0;c<T;c++)this.h.h=!0,s+=this.h.i.decode(f[c],{stream:!(A&&c==T-1)});f.length=0,this.h.g+=s,this.C=0,b=this.h.g}else b=this.g.oa();if(this.o=u==200,mh(this.i,this.u,this.A,this.l,this.R,ge,u),this.o){if(this.T&&!this.K){t:{if(this.g){var G,le=this.g;if((G=le.g?le.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!q(G)){var K=G;break t}}K=null}if(u=K)Kt(this.i,this.l,u,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Mi(this,u);else{this.o=!1,this.s=3,Te(12),Ct(this),Cn(this);break e}}if(this.P){u=!0;let De;for(;!this.J&&this.C<b.length;)if(De=vh(this,b),De==Vi){ge==4&&(this.s=4,Te(14),u=!1),Kt(this.i,this.l,null,"[Incomplete Response]");break}else if(De==No){this.s=4,Te(15),Kt(this.i,this.l,b,"[Invalid Chunk]"),u=!1;break}else Kt(this.i,this.l,De,null),Mi(this,De);if(Mo(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),ge!=4||b.length!=0||this.h.h||(this.s=1,Te(16),u=!1),this.o=this.o&&u,!u)Kt(this.i,this.l,b,"[Invalid Chunked Response]"),Ct(this),Cn(this);else if(0<b.length&&!this.W){this.W=!0;var pe=this.j;pe.g==this&&pe.ba&&!pe.M&&(pe.j.info("Great, no buffering proxy detected. Bytes received: "+b.length),ji(pe),pe.M=!0,Te(11))}}else Kt(this.i,this.l,b,null),Mi(this,b);ge==4&&Ct(this),this.o&&!this.J&&(ge==4?la(this.j,this):(this.o=!1,mr(this)))}else Mh(this.g),u==400&&0<b.indexOf("Unknown SID")?(this.s=3,Te(12)):(this.s=0,Te(13)),Ct(this),Cn(this)}}}catch{}finally{}};function Mo(s){return s.g?s.u=="GET"&&s.L!=2&&s.j.Ca:!1}function vh(s,c){var u=s.C,f=c.indexOf(`
`,u);return f==-1?Vi:(u=Number(c.substring(u,f)),isNaN(u)?No:(f+=1,f+u>c.length?Vi:(c=c.slice(f,f+u),s.C=f+u,c)))}et.prototype.cancel=function(){this.J=!0,Ct(this)};function mr(s){s.S=Date.now()+s.I,xo(s,s.I)}function xo(s,c){if(s.B!=null)throw Error("WatchDog timer not null");s.B=An(R(s.ba,s),c)}function Li(s){s.B&&(l.clearTimeout(s.B),s.B=null)}et.prototype.ba=function(){this.B=null;const s=Date.now();0<=s-this.S?(_h(this.i,this.A),this.L!=2&&(wn(),Te(17)),Ct(this),this.s=2,Cn(this)):xo(this,this.S-s)};function Cn(s){s.j.G==0||s.J||la(s.j,s)}function Ct(s){Li(s);var c=s.M;c&&typeof c.ma=="function"&&c.ma(),s.M=null,Ro(s.U),s.g&&(c=s.g,s.g=null,c.abort(),c.ma())}function Mi(s,c){try{var u=s.j;if(u.G!=0&&(u.g==s||xi(u.h,s))){if(!s.K&&xi(u.h,s)&&u.G==3){try{var f=u.Da.g.parse(c)}catch{f=null}if(Array.isArray(f)&&f.length==3){var T=f;if(T[0]==0){e:if(!u.u){if(u.g)if(u.g.F+3e3<s.F)Rr(u),wr(u);else break e;$i(u),Te(18)}}else u.za=T[1],0<u.za-u.T&&37500>T[2]&&u.F&&u.v==0&&!u.C&&(u.C=An(R(u.Za,u),6e3));if(1>=Bo(u.h)&&u.ca){try{u.ca()}catch{}u.ca=void 0}}else bt(u,11)}else if((s.K||u.g==s)&&Rr(u),!q(c))for(T=u.Da.g.parse(c),c=0;c<T.length;c++){let K=T[c];if(u.T=K[0],K=K[1],u.G==2)if(K[0]=="c"){u.K=K[1],u.ia=K[2];const pe=K[3];pe!=null&&(u.la=pe,u.j.info("VER="+u.la));const ge=K[4];ge!=null&&(u.Aa=ge,u.j.info("SVER="+u.Aa));const Wt=K[5];Wt!=null&&typeof Wt=="number"&&0<Wt&&(f=1.5*Wt,u.L=f,u.j.info("backChannelRequestTimeoutMs_="+f)),f=u;const De=s.g;if(De){const Sr=De.g?De.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Sr){var A=f.h;A.g||Sr.indexOf("spdy")==-1&&Sr.indexOf("quic")==-1&&Sr.indexOf("h2")==-1||(A.j=A.l,A.g=new Set,A.h&&(Fi(A,A.h),A.h=null))}if(f.D){const qi=De.g?De.g.getResponseHeader("X-HTTP-Session-Id"):null;qi&&(f.ya=qi,Y(f.I,f.D,qi))}}u.G=3,u.l&&u.l.ua(),u.ba&&(u.R=Date.now()-s.F,u.j.info("Handshake RTT: "+u.R+"ms")),f=u;var b=s;if(f.qa=da(f,f.J?f.ia:null,f.W),b.K){$o(f.h,b);var G=b,le=f.L;le&&(G.I=le),G.B&&(Li(G),mr(G)),f.g=b}else aa(f);0<u.i.length&&Ar(u)}else K[0]!="stop"&&K[0]!="close"||bt(u,7);else u.G==3&&(K[0]=="stop"||K[0]=="close"?K[0]=="stop"?bt(u,7):Bi(u):K[0]!="noop"&&u.l&&u.l.ta(K),u.v=0)}}wn(4)}catch{}}var Ih=class{constructor(s,c){this.g=s,this.map=c}};function Fo(s){this.l=s||10,l.PerformanceNavigationTiming?(s=l.performance.getEntriesByType("navigation"),s=0<s.length&&(s[0].nextHopProtocol=="hq"||s[0].nextHopProtocol=="h2")):s=!!(l.chrome&&l.chrome.loadTimes&&l.chrome.loadTimes()&&l.chrome.loadTimes().wasFetchedViaSpdy),this.j=s?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function Uo(s){return s.h?!0:s.g?s.g.size>=s.j:!1}function Bo(s){return s.h?1:s.g?s.g.size:0}function xi(s,c){return s.h?s.h==c:s.g?s.g.has(c):!1}function Fi(s,c){s.g?s.g.add(c):s.h=c}function $o(s,c){s.h&&s.h==c?s.h=null:s.g&&s.g.has(c)&&s.g.delete(c)}Fo.prototype.cancel=function(){if(this.i=jo(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const s of this.g.values())s.cancel();this.g.clear()}};function jo(s){if(s.h!=null)return s.i.concat(s.h.D);if(s.g!=null&&s.g.size!==0){let c=s.i;for(const u of s.g.values())c=c.concat(u.D);return c}return L(s.i)}function Eh(s){if(s.V&&typeof s.V=="function")return s.V();if(typeof Map<"u"&&s instanceof Map||typeof Set<"u"&&s instanceof Set)return Array.from(s.values());if(typeof s=="string")return s.split("");if(h(s)){for(var c=[],u=s.length,f=0;f<u;f++)c.push(s[f]);return c}c=[],u=0;for(f in s)c[u++]=s[f];return c}function Th(s){if(s.na&&typeof s.na=="function")return s.na();if(!s.V||typeof s.V!="function"){if(typeof Map<"u"&&s instanceof Map)return Array.from(s.keys());if(!(typeof Set<"u"&&s instanceof Set)){if(h(s)||typeof s=="string"){var c=[];s=s.length;for(var u=0;u<s;u++)c.push(u);return c}c=[],u=0;for(const f in s)c[u++]=f;return c}}}function qo(s,c){if(s.forEach&&typeof s.forEach=="function")s.forEach(c,void 0);else if(h(s)||typeof s=="string")Array.prototype.forEach.call(s,c,void 0);else for(var u=Th(s),f=Eh(s),T=f.length,A=0;A<T;A++)c.call(void 0,f[A],u&&u[A],s)}var Ko=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function wh(s,c){if(s){s=s.split("&");for(var u=0;u<s.length;u++){var f=s[u].indexOf("="),T=null;if(0<=f){var A=s[u].substring(0,f);T=s[u].substring(f+1)}else A=s[u];c(A,T?decodeURIComponent(T.replace(/\+/g," ")):"")}}}function St(s){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,s instanceof St){this.h=s.h,_r(this,s.j),this.o=s.o,this.g=s.g,yr(this,s.s),this.l=s.l;var c=s.i,u=new Pn;u.i=c.i,c.g&&(u.g=new Map(c.g),u.h=c.h),zo(this,u),this.m=s.m}else s&&(c=String(s).match(Ko))?(this.h=!1,_r(this,c[1]||"",!0),this.o=Sn(c[2]||""),this.g=Sn(c[3]||"",!0),yr(this,c[4]),this.l=Sn(c[5]||"",!0),zo(this,c[6]||"",!0),this.m=Sn(c[7]||"")):(this.h=!1,this.i=new Pn(null,this.h))}St.prototype.toString=function(){var s=[],c=this.j;c&&s.push(bn(c,Ho,!0),":");var u=this.g;return(u||c=="file")&&(s.push("//"),(c=this.o)&&s.push(bn(c,Ho,!0),"@"),s.push(encodeURIComponent(String(u)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),u=this.s,u!=null&&s.push(":",String(u))),(u=this.l)&&(this.g&&u.charAt(0)!="/"&&s.push("/"),s.push(bn(u,u.charAt(0)=="/"?Ch:Rh,!0))),(u=this.i.toString())&&s.push("?",u),(u=this.m)&&s.push("#",bn(u,bh)),s.join("")};function je(s){return new St(s)}function _r(s,c,u){s.j=u?Sn(c,!0):c,s.j&&(s.j=s.j.replace(/:$/,""))}function yr(s,c){if(c){if(c=Number(c),isNaN(c)||0>c)throw Error("Bad port number "+c);s.s=c}else s.s=null}function zo(s,c,u){c instanceof Pn?(s.i=c,Ph(s.i,s.h)):(u||(c=bn(c,Sh)),s.i=new Pn(c,s.h))}function Y(s,c,u){s.i.set(c,u)}function vr(s){return Y(s,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),s}function Sn(s,c){return s?c?decodeURI(s.replace(/%25/g,"%2525")):decodeURIComponent(s):""}function bn(s,c,u){return typeof s=="string"?(s=encodeURI(s).replace(c,Ah),u&&(s=s.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),s):null}function Ah(s){return s=s.charCodeAt(0),"%"+(s>>4&15).toString(16)+(s&15).toString(16)}var Ho=/[#\/\?@]/g,Rh=/[#\?:]/g,Ch=/[#\?]/g,Sh=/[#\?@]/g,bh=/#/g;function Pn(s,c){this.h=this.g=null,this.i=s||null,this.j=!!c}function tt(s){s.g||(s.g=new Map,s.h=0,s.i&&wh(s.i,function(c,u){s.add(decodeURIComponent(c.replace(/\+/g," ")),u)}))}n=Pn.prototype,n.add=function(s,c){tt(this),this.i=null,s=zt(this,s);var u=this.g.get(s);return u||this.g.set(s,u=[]),u.push(c),this.h+=1,this};function Wo(s,c){tt(s),c=zt(s,c),s.g.has(c)&&(s.i=null,s.h-=s.g.get(c).length,s.g.delete(c))}function Go(s,c){return tt(s),c=zt(s,c),s.g.has(c)}n.forEach=function(s,c){tt(this),this.g.forEach(function(u,f){u.forEach(function(T){s.call(c,T,f,this)},this)},this)},n.na=function(){tt(this);const s=Array.from(this.g.values()),c=Array.from(this.g.keys()),u=[];for(let f=0;f<c.length;f++){const T=s[f];for(let A=0;A<T.length;A++)u.push(c[f])}return u},n.V=function(s){tt(this);let c=[];if(typeof s=="string")Go(this,s)&&(c=c.concat(this.g.get(zt(this,s))));else{s=Array.from(this.g.values());for(let u=0;u<s.length;u++)c=c.concat(s[u])}return c},n.set=function(s,c){return tt(this),this.i=null,s=zt(this,s),Go(this,s)&&(this.h-=this.g.get(s).length),this.g.set(s,[c]),this.h+=1,this},n.get=function(s,c){return s?(s=this.V(s),0<s.length?String(s[0]):c):c};function Qo(s,c,u){Wo(s,c),0<u.length&&(s.i=null,s.g.set(zt(s,c),L(u)),s.h+=u.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const s=[],c=Array.from(this.g.keys());for(var u=0;u<c.length;u++){var f=c[u];const A=encodeURIComponent(String(f)),b=this.V(f);for(f=0;f<b.length;f++){var T=A;b[f]!==""&&(T+="="+encodeURIComponent(String(b[f]))),s.push(T)}}return this.i=s.join("&")};function zt(s,c){return c=String(c),s.j&&(c=c.toLowerCase()),c}function Ph(s,c){c&&!s.j&&(tt(s),s.i=null,s.g.forEach(function(u,f){var T=f.toLowerCase();f!=T&&(Wo(this,f),Qo(this,T,u))},s)),s.j=c}function kh(s,c){const u=new Rn;if(l.Image){const f=new Image;f.onload=C(nt,u,"TestLoadImage: loaded",!0,c,f),f.onerror=C(nt,u,"TestLoadImage: error",!1,c,f),f.onabort=C(nt,u,"TestLoadImage: abort",!1,c,f),f.ontimeout=C(nt,u,"TestLoadImage: timeout",!1,c,f),l.setTimeout(function(){f.ontimeout&&f.ontimeout()},1e4),f.src=s}else c(!1)}function Dh(s,c){const u=new Rn,f=new AbortController,T=setTimeout(()=>{f.abort(),nt(u,"TestPingServer: timeout",!1,c)},1e4);fetch(s,{signal:f.signal}).then(A=>{clearTimeout(T),A.ok?nt(u,"TestPingServer: ok",!0,c):nt(u,"TestPingServer: server error",!1,c)}).catch(()=>{clearTimeout(T),nt(u,"TestPingServer: error",!1,c)})}function nt(s,c,u,f,T){try{T&&(T.onload=null,T.onerror=null,T.onabort=null,T.ontimeout=null),f(u)}catch{}}function Oh(){this.g=new ph}function Vh(s,c,u){const f=u||"";try{qo(s,function(T,A){let b=T;d(T)&&(b=bi(T)),c.push(f+A+"="+encodeURIComponent(b))})}catch(T){throw c.push(f+"type="+encodeURIComponent("_badmap")),T}}function Ir(s){this.l=s.Ub||null,this.j=s.eb||!1}D(Ir,Pi),Ir.prototype.g=function(){return new Er(this.l,this.j)},Ir.prototype.i=function(s){return function(){return s}}({});function Er(s,c){fe.call(this),this.D=s,this.o=c,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}D(Er,fe),n=Er.prototype,n.open=function(s,c){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=s,this.A=c,this.readyState=1,Dn(this)},n.send=function(s){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const c={headers:this.u,method:this.B,credentials:this.m,cache:void 0};s&&(c.body=s),(this.D||l).fetch(new Request(this.A,c)).then(this.Sa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,kn(this)),this.readyState=0},n.Sa=function(s){if(this.g&&(this.l=s,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=s.headers,this.readyState=2,Dn(this)),this.g&&(this.readyState=3,Dn(this),this.g)))if(this.responseType==="arraybuffer")s.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof l.ReadableStream<"u"&&"body"in s){if(this.j=s.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;Jo(this)}else s.text().then(this.Ra.bind(this),this.ga.bind(this))};function Jo(s){s.j.read().then(s.Pa.bind(s)).catch(s.ga.bind(s))}n.Pa=function(s){if(this.g){if(this.o&&s.value)this.response.push(s.value);else if(!this.o){var c=s.value?s.value:new Uint8Array(0);(c=this.v.decode(c,{stream:!s.done}))&&(this.response=this.responseText+=c)}s.done?kn(this):Dn(this),this.readyState==3&&Jo(this)}},n.Ra=function(s){this.g&&(this.response=this.responseText=s,kn(this))},n.Qa=function(s){this.g&&(this.response=s,kn(this))},n.ga=function(){this.g&&kn(this)};function kn(s){s.readyState=4,s.l=null,s.j=null,s.v=null,Dn(s)}n.setRequestHeader=function(s,c){this.u.append(s,c)},n.getResponseHeader=function(s){return this.h&&this.h.get(s.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const s=[],c=this.h.entries();for(var u=c.next();!u.done;)u=u.value,s.push(u[0]+": "+u[1]),u=c.next();return s.join(`\r
`)};function Dn(s){s.onreadystatechange&&s.onreadystatechange.call(s)}Object.defineProperty(Er.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(s){this.m=s?"include":"same-origin"}});function Yo(s){let c="";return J(s,function(u,f){c+=f,c+=":",c+=u,c+=`\r
`}),c}function Ui(s,c,u){e:{for(f in u){var f=!1;break e}f=!0}f||(u=Yo(u),typeof s=="string"?u!=null&&encodeURIComponent(String(u)):Y(s,c,u))}function ee(s){fe.call(this),this.headers=new Map,this.o=s||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}D(ee,fe);var Nh=/^https?$/i,Lh=["POST","PUT"];n=ee.prototype,n.Ha=function(s){this.J=s},n.ea=function(s,c,u,f){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+s);c=c?c.toUpperCase():"GET",this.D=s,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():Oi.g(),this.v=this.o?Co(this.o):Co(Oi),this.g.onreadystatechange=R(this.Ea,this);try{this.B=!0,this.g.open(c,String(s),!0),this.B=!1}catch(A){Xo(this,A);return}if(s=u||"",u=new Map(this.headers),f)if(Object.getPrototypeOf(f)===Object.prototype)for(var T in f)u.set(T,f[T]);else if(typeof f.keys=="function"&&typeof f.get=="function")for(const A of f.keys())u.set(A,f.get(A));else throw Error("Unknown input type for opt_headers: "+String(f));f=Array.from(u.keys()).find(A=>A.toLowerCase()=="content-type"),T=l.FormData&&s instanceof l.FormData,!(0<=Array.prototype.indexOf.call(Lh,c,void 0))||f||T||u.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[A,b]of u)this.g.setRequestHeader(A,b);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{ta(this),this.u=!0,this.g.send(s),this.u=!1}catch(A){Xo(this,A)}};function Xo(s,c){s.h=!1,s.g&&(s.j=!0,s.g.abort(),s.j=!1),s.l=c,s.m=5,Zo(s),Tr(s)}function Zo(s){s.A||(s.A=!0,Ee(s,"complete"),Ee(s,"error"))}n.abort=function(s){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=s||7,Ee(this,"complete"),Ee(this,"abort"),Tr(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Tr(this,!0)),ee.aa.N.call(this)},n.Ea=function(){this.s||(this.B||this.u||this.j?ea(this):this.bb())},n.bb=function(){ea(this)};function ea(s){if(s.h&&typeof a<"u"&&(!s.v[1]||qe(s)!=4||s.Z()!=2)){if(s.u&&qe(s)==4)To(s.Ea,0,s);else if(Ee(s,"readystatechange"),qe(s)==4){s.h=!1;try{const b=s.Z();e:switch(b){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var c=!0;break e;default:c=!1}var u;if(!(u=c)){var f;if(f=b===0){var T=String(s.D).match(Ko)[1]||null;!T&&l.self&&l.self.location&&(T=l.self.location.protocol.slice(0,-1)),f=!Nh.test(T?T.toLowerCase():"")}u=f}if(u)Ee(s,"complete"),Ee(s,"success");else{s.m=6;try{var A=2<qe(s)?s.g.statusText:""}catch{A=""}s.l=A+" ["+s.Z()+"]",Zo(s)}}finally{Tr(s)}}}}function Tr(s,c){if(s.g){ta(s);const u=s.g,f=s.v[0]?()=>{}:null;s.g=null,s.v=null,c||Ee(s,"ready");try{u.onreadystatechange=f}catch{}}}function ta(s){s.I&&(l.clearTimeout(s.I),s.I=null)}n.isActive=function(){return!!this.g};function qe(s){return s.g?s.g.readyState:0}n.Z=function(){try{return 2<qe(this)?this.g.status:-1}catch{return-1}},n.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.Oa=function(s){if(this.g){var c=this.g.responseText;return s&&c.indexOf(s)==0&&(c=c.substring(s.length)),fh(c)}};function na(s){try{if(!s.g)return null;if("response"in s.g)return s.g.response;switch(s.H){case"":case"text":return s.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in s.g)return s.g.mozResponseArrayBuffer}return null}catch{return null}}function Mh(s){const c={};s=(s.g&&2<=qe(s)&&s.g.getAllResponseHeaders()||"").split(`\r
`);for(let f=0;f<s.length;f++){if(q(s[f]))continue;var u=y(s[f]);const T=u[0];if(u=u[1],typeof u!="string")continue;u=u.trim();const A=c[T]||[];c[T]=A,A.push(u)}E(c,function(f){return f.join(", ")})}n.Ba=function(){return this.m},n.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function On(s,c,u){return u&&u.internalChannelParams&&u.internalChannelParams[s]||c}function ra(s){this.Aa=0,this.i=[],this.j=new Rn,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=On("failFast",!1,s),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=On("baseRetryDelayMs",5e3,s),this.cb=On("retryDelaySeedMs",1e4,s),this.Wa=On("forwardChannelMaxRetries",2,s),this.wa=On("forwardChannelRequestTimeoutMs",2e4,s),this.pa=s&&s.xmlHttpFactory||void 0,this.Xa=s&&s.Tb||void 0,this.Ca=s&&s.useFetchStreams||!1,this.L=void 0,this.J=s&&s.supportsCrossDomainXhr||!1,this.K="",this.h=new Fo(s&&s.concurrentRequestLimit),this.Da=new Oh,this.P=s&&s.fastHandshake||!1,this.O=s&&s.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=s&&s.Rb||!1,s&&s.xa&&this.j.xa(),s&&s.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&s&&s.detectBufferingProxy||!1,this.ja=void 0,s&&s.longPollingTimeout&&0<s.longPollingTimeout&&(this.ja=s.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}n=ra.prototype,n.la=8,n.G=1,n.connect=function(s,c,u,f){Te(0),this.W=s,this.H=c||{},u&&f!==void 0&&(this.H.OSID=u,this.H.OAID=f),this.F=this.X,this.I=da(this,null,this.W),Ar(this)};function Bi(s){if(ia(s),s.G==3){var c=s.U++,u=je(s.I);if(Y(u,"SID",s.K),Y(u,"RID",c),Y(u,"TYPE","terminate"),Vn(s,u),c=new et(s,s.j,c),c.L=2,c.v=vr(je(u)),u=!1,l.navigator&&l.navigator.sendBeacon)try{u=l.navigator.sendBeacon(c.v.toString(),"")}catch{}!u&&l.Image&&(new Image().src=c.v,u=!0),u||(c.g=fa(c.j,null),c.g.ea(c.v)),c.F=Date.now(),mr(c)}ha(s)}function wr(s){s.g&&(ji(s),s.g.cancel(),s.g=null)}function ia(s){wr(s),s.u&&(l.clearTimeout(s.u),s.u=null),Rr(s),s.h.cancel(),s.s&&(typeof s.s=="number"&&l.clearTimeout(s.s),s.s=null)}function Ar(s){if(!Uo(s.h)&&!s.s){s.s=!0;var c=s.Ga;It||lr(),Et||(It(),Et=!0),cr.add(c,s),s.B=0}}function xh(s,c){return Bo(s.h)>=s.h.j-(s.s?1:0)?!1:s.s?(s.i=c.D.concat(s.i),!0):s.G==1||s.G==2||s.B>=(s.Va?0:s.Wa)?!1:(s.s=An(R(s.Ga,s,c),ua(s,s.B)),s.B++,!0)}n.Ga=function(s){if(this.s)if(this.s=null,this.G==1){if(!s){this.U=Math.floor(1e5*Math.random()),s=this.U++;const T=new et(this,this.j,s);let A=this.o;if(this.S&&(A?(A=g(A),v(A,this.S)):A=this.S),this.m!==null||this.O||(T.H=A,A=null),this.P)e:{for(var c=0,u=0;u<this.i.length;u++){t:{var f=this.i[u];if("__data__"in f.map&&(f=f.map.__data__,typeof f=="string")){f=f.length;break t}f=void 0}if(f===void 0)break;if(c+=f,4096<c){c=u;break e}if(c===4096||u===this.i.length-1){c=u+1;break e}}c=1e3}else c=1e3;c=oa(this,T,c),u=je(this.I),Y(u,"RID",s),Y(u,"CVER",22),this.D&&Y(u,"X-HTTP-Session-Id",this.D),Vn(this,u),A&&(this.O?c="headers="+encodeURIComponent(String(Yo(A)))+"&"+c:this.m&&Ui(u,this.m,A)),Fi(this.h,T),this.Ua&&Y(u,"TYPE","init"),this.P?(Y(u,"$req",c),Y(u,"SID","null"),T.T=!0,Ni(T,u,null)):Ni(T,u,c),this.G=2}}else this.G==3&&(s?sa(this,s):this.i.length==0||Uo(this.h)||sa(this))};function sa(s,c){var u;c?u=c.l:u=s.U++;const f=je(s.I);Y(f,"SID",s.K),Y(f,"RID",u),Y(f,"AID",s.T),Vn(s,f),s.m&&s.o&&Ui(f,s.m,s.o),u=new et(s,s.j,u,s.B+1),s.m===null&&(u.H=s.o),c&&(s.i=c.D.concat(s.i)),c=oa(s,u,1e3),u.I=Math.round(.5*s.wa)+Math.round(.5*s.wa*Math.random()),Fi(s.h,u),Ni(u,f,c)}function Vn(s,c){s.H&&J(s.H,function(u,f){Y(c,f,u)}),s.l&&qo({},function(u,f){Y(c,f,u)})}function oa(s,c,u){u=Math.min(s.i.length,u);var f=s.l?R(s.l.Na,s.l,s):null;e:{var T=s.i;let A=-1;for(;;){const b=["count="+u];A==-1?0<u?(A=T[0].g,b.push("ofs="+A)):A=0:b.push("ofs="+A);let G=!0;for(let le=0;le<u;le++){let K=T[le].g;const pe=T[le].map;if(K-=A,0>K)A=Math.max(0,T[le].g-100),G=!1;else try{Vh(pe,b,"req"+K+"_")}catch{f&&f(pe)}}if(G){f=b.join("&");break e}}}return s=s.i.splice(0,u),c.D=s,f}function aa(s){if(!s.g&&!s.u){s.Y=1;var c=s.Fa;It||lr(),Et||(It(),Et=!0),cr.add(c,s),s.v=0}}function $i(s){return s.g||s.u||3<=s.v?!1:(s.Y++,s.u=An(R(s.Fa,s),ua(s,s.v)),s.v++,!0)}n.Fa=function(){if(this.u=null,ca(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var s=2*this.R;this.j.info("BP detection timer enabled: "+s),this.A=An(R(this.ab,this),s)}},n.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,Te(10),wr(this),ca(this))};function ji(s){s.A!=null&&(l.clearTimeout(s.A),s.A=null)}function ca(s){s.g=new et(s,s.j,"rpc",s.Y),s.m===null&&(s.g.H=s.o),s.g.O=0;var c=je(s.qa);Y(c,"RID","rpc"),Y(c,"SID",s.K),Y(c,"AID",s.T),Y(c,"CI",s.F?"0":"1"),!s.F&&s.ja&&Y(c,"TO",s.ja),Y(c,"TYPE","xmlhttp"),Vn(s,c),s.m&&s.o&&Ui(c,s.m,s.o),s.L&&(s.g.I=s.L);var u=s.g;s=s.ia,u.L=1,u.v=vr(je(c)),u.m=null,u.P=!0,Lo(u,s)}n.Za=function(){this.C!=null&&(this.C=null,wr(this),$i(this),Te(19))};function Rr(s){s.C!=null&&(l.clearTimeout(s.C),s.C=null)}function la(s,c){var u=null;if(s.g==c){Rr(s),ji(s),s.g=null;var f=2}else if(xi(s.h,c))u=c.D,$o(s.h,c),f=1;else return;if(s.G!=0){if(c.o)if(f==1){u=c.m?c.m.length:0,c=Date.now()-c.F;var T=s.B;f=fr(),Ee(f,new Do(f,u)),Ar(s)}else aa(s);else if(T=c.s,T==3||T==0&&0<c.X||!(f==1&&xh(s,c)||f==2&&$i(s)))switch(u&&0<u.length&&(c=s.h,c.i=c.i.concat(u)),T){case 1:bt(s,5);break;case 4:bt(s,10);break;case 3:bt(s,6);break;default:bt(s,2)}}}function ua(s,c){let u=s.Ta+Math.floor(Math.random()*s.cb);return s.isActive()||(u*=2),u*c}function bt(s,c){if(s.j.info("Error code "+c),c==2){var u=R(s.fb,s),f=s.Xa;const T=!f;f=new St(f||"//www.google.com/images/cleardot.gif"),l.location&&l.location.protocol=="http"||_r(f,"https"),vr(f),T?kh(f.toString(),u):Dh(f.toString(),u)}else Te(2);s.G=0,s.l&&s.l.sa(c),ha(s),ia(s)}n.fb=function(s){s?(this.j.info("Successfully pinged google.com"),Te(2)):(this.j.info("Failed to ping google.com"),Te(1))};function ha(s){if(s.G=0,s.ka=[],s.l){const c=jo(s.h);(c.length!=0||s.i.length!=0)&&(k(s.ka,c),k(s.ka,s.i),s.h.i.length=0,L(s.i),s.i.length=0),s.l.ra()}}function da(s,c,u){var f=u instanceof St?je(u):new St(u);if(f.g!="")c&&(f.g=c+"."+f.g),yr(f,f.s);else{var T=l.location;f=T.protocol,c=c?c+"."+T.hostname:T.hostname,T=+T.port;var A=new St(null);f&&_r(A,f),c&&(A.g=c),T&&yr(A,T),u&&(A.l=u),f=A}return u=s.D,c=s.ya,u&&c&&Y(f,u,c),Y(f,"VER",s.la),Vn(s,f),f}function fa(s,c,u){if(c&&!s.J)throw Error("Can't create secondary domain capable XhrIo object.");return c=s.Ca&&!s.pa?new ee(new Ir({eb:u})):new ee(s.pa),c.Ha(s.J),c}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function pa(){}n=pa.prototype,n.ua=function(){},n.ta=function(){},n.sa=function(){},n.ra=function(){},n.isActive=function(){return!0},n.Na=function(){};function Cr(){}Cr.prototype.g=function(s,c){return new Ce(s,c)};function Ce(s,c){fe.call(this),this.g=new ra(c),this.l=s,this.h=c&&c.messageUrlParams||null,s=c&&c.messageHeaders||null,c&&c.clientProtocolHeaderRequired&&(s?s["X-Client-Protocol"]="webchannel":s={"X-Client-Protocol":"webchannel"}),this.g.o=s,s=c&&c.initMessageHeaders||null,c&&c.messageContentType&&(s?s["X-WebChannel-Content-Type"]=c.messageContentType:s={"X-WebChannel-Content-Type":c.messageContentType}),c&&c.va&&(s?s["X-WebChannel-Client-Profile"]=c.va:s={"X-WebChannel-Client-Profile":c.va}),this.g.S=s,(s=c&&c.Sb)&&!q(s)&&(this.g.m=s),this.v=c&&c.supportsCrossDomainXhr||!1,this.u=c&&c.sendRawJson||!1,(c=c&&c.httpSessionIdParam)&&!q(c)&&(this.g.D=c,s=this.h,s!==null&&c in s&&(s=this.h,c in s&&delete s[c])),this.j=new Ht(this)}D(Ce,fe),Ce.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},Ce.prototype.close=function(){Bi(this.g)},Ce.prototype.o=function(s){var c=this.g;if(typeof s=="string"){var u={};u.__data__=s,s=u}else this.u&&(u={},u.__data__=bi(s),s=u);c.i.push(new Ih(c.Ya++,s)),c.G==3&&Ar(c)},Ce.prototype.N=function(){this.g.l=null,delete this.j,Bi(this.g),delete this.g,Ce.aa.N.call(this)};function ga(s){ki.call(this),s.__headers__&&(this.headers=s.__headers__,this.statusCode=s.__status__,delete s.__headers__,delete s.__status__);var c=s.__sm__;if(c){e:{for(const u in c){s=u;break e}s=void 0}(this.i=s)&&(s=this.i,c=c!==null&&s in c?c[s]:void 0),this.data=c}else this.data=s}D(ga,ki);function ma(){Di.call(this),this.status=1}D(ma,Di);function Ht(s){this.g=s}D(Ht,pa),Ht.prototype.ua=function(){Ee(this.g,"a")},Ht.prototype.ta=function(s){Ee(this.g,new ga(s))},Ht.prototype.sa=function(s){Ee(this.g,new ma)},Ht.prototype.ra=function(){Ee(this.g,"b")},Cr.prototype.createWebChannel=Cr.prototype.g,Ce.prototype.send=Ce.prototype.o,Ce.prototype.open=Ce.prototype.m,Ce.prototype.close=Ce.prototype.close,ll=function(){return new Cr},cl=function(){return fr()},al=Rt,hs={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},pr.NO_ERROR=0,pr.TIMEOUT=8,pr.HTTP_ERROR=6,Nr=pr,Oo.COMPLETE="complete",ol=Oo,So.EventType=Tn,Tn.OPEN="a",Tn.CLOSE="b",Tn.ERROR="c",Tn.MESSAGE="d",fe.prototype.listen=fe.prototype.K,xn=So,ee.prototype.listenOnce=ee.prototype.L,ee.prototype.getLastError=ee.prototype.Ka,ee.prototype.getLastErrorCode=ee.prototype.Ba,ee.prototype.getStatus=ee.prototype.Z,ee.prototype.getResponseJson=ee.prototype.Oa,ee.prototype.getResponseText=ee.prototype.oa,ee.prototype.send=ee.prototype.ea,ee.prototype.setWithCredentials=ee.prototype.Ha,sl=ee}).apply(typeof br<"u"?br:typeof self<"u"?self:typeof window<"u"?window:{});const Pa="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ul{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class Ef{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable(()=>t(_e.UNAUTHENTICATED))}shutdown(){}}class Tf{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable(()=>t(this.token.user))}shutdown(){this.changeListener=null}}class wf{constructor(e){this.t=e,this.currentUser=_e.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){te(this.o===void 0);let r=this.i;const i=h=>this.i!==r?(r=this.i,t(h)):Promise.resolve();let o=new Vt;this.o=()=>{this.i++,this.currentUser=this.u(),o.resolve(),o=new Vt,e.enqueueRetryable(()=>i(this.currentUser))};const a=()=>{const h=o;e.enqueueRetryable(async()=>{await h.promise,await i(this.currentUser)})},l=h=>{O("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=h,this.o&&(this.auth.addAuthTokenListener(this.o),a())};this.t.onInit(h=>l(h)),setTimeout(()=>{if(!this.auth){const h=this.t.getImmediate({optional:!0});h?l(h):(O("FirebaseAuthCredentialsProvider","Auth not yet detected"),o.resolve(),o=new Vt)}},0),a()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then(r=>this.i!==e?(O("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(te(typeof r.accessToken=="string"),new ul(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return te(e===null||typeof e=="string"),new _e(e)}}class Af{constructor(e,t,r){this.l=e,this.h=t,this.P=r,this.type="FirstParty",this.user=_e.FIRST_PARTY,this.I=new Map}T(){return this.P?this.P():null}get headers(){this.I.set("X-Goog-AuthUser",this.l);const e=this.T();return e&&this.I.set("Authorization",e),this.h&&this.I.set("X-Goog-Iam-Authorization-Token",this.h),this.I}}class Rf{constructor(e,t,r){this.l=e,this.h=t,this.P=r}getToken(){return Promise.resolve(new Af(this.l,this.h,this.P))}start(e,t){e.enqueueRetryable(()=>t(_e.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class Cf{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class Sf{constructor(e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(e,t){te(this.o===void 0);const r=o=>{o.error!=null&&O("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${o.error.message}`);const a=o.token!==this.R;return this.R=o.token,O("FirebaseAppCheckTokenProvider",`Received ${a?"new":"existing"} token.`),a?t(o.token):Promise.resolve()};this.o=o=>{e.enqueueRetryable(()=>r(o))};const i=o=>{O("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=o,this.o&&this.appCheck.addTokenListener(this.o)};this.A.onInit(o=>i(o)),setTimeout(()=>{if(!this.appCheck){const o=this.A.getImmediate({optional:!0});o?i(o):O("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(t=>t?(te(typeof t.token=="string"),this.R=t.token,new Cf(t.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ls(n){if(n.code!==P.FAILED_PRECONDITION||n.message!==Vf)throw n;O("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class de{constructor(e){this.binaryString=e}static fromBase64String(e){const t=function(i){try{return atob(i)}catch(o){throw typeof DOMException<"u"&&o instanceof DOMException?new dl("Invalid base64 string: "+o):o}}(e);return new de(t)}static fromUint8Array(e){const t=function(i){let o="";for(let a=0;a<i.length;++a)o+=String.fromCharCode(i[a]);return o}(e);return new de(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(t){return btoa(t)}(this.binaryString)}toUint8Array(){return function(t){const r=new Uint8Array(t.length);for(let i=0;i<t.length;i++)r[i]=t.charCodeAt(i);return r}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return H(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}de.EMPTY_BYTE_STRING=new de("");const xf=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function mt(n){if(te(!!n),typeof n=="string"){let e=0;const t=xf.exec(n);if(te(!!t),t[1]){let i=t[1];i=(i+"000000000").substr(0,9),e=Number(i)}const r=new Date(n);return{seconds:Math.floor(r.getTime()/1e3),nanos:e}}return{seconds:ne(n.seconds),nanos:ne(n.nanos)}}function ne(n){return typeof n=="number"?n:typeof n=="string"?Number(n):0}function Mt(n){return typeof n=="string"?de.fromBase64String(n):de.fromUint8Array(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ye{constructor(e,t,r,i,o,a,l){this.key=e,this.documentType=t,this.version=r,this.readTime=i,this.createTime=o,this.data=a,this.documentState=l}static newInvalidDocument(e){return new ye(e,0,x.min(),x.min(),x.min(),Le.empty(),0)}static newFoundDocument(e,t,r,i){return new ye(e,1,t,x.min(),r,i,0)}static newNoDocument(e,t){return new ye(e,2,t,x.min(),x.min(),Le.empty(),0)}static newUnknownDocument(e,t){return new ye(e,3,t,x.min(),x.min(),Le.empty(),2)}convertToFoundDocument(e,t){return!this.createTime.isEqual(x.min())||this.documentType!==2&&this.documentType!==0||(this.createTime=e),this.version=e,this.documentType=1,this.data=t,this.documentState=0,this}convertToNoDocument(e){return this.version=e,this.documentType=2,this.data=Le.empty(),this.documentState=0,this}convertToUnknownDocument(e){return this.version=e,this.documentType=3,this.data=Le.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=x.min(),this}setReadTime(e){return this.readTime=e,this}get hasLocalMutations(){return this.documentState===1}get hasCommittedMutations(){return this.documentState===2}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return this.documentType!==0}isFoundDocument(){return this.documentType===1}isNoDocument(){return this.documentType===2}isUnknownDocument(){return this.documentType===3}isEqual(e){return e instanceof ye&&this.key.isEqual(e.key)&&this.version.isEqual(e.version)&&this.documentType===e.documentType&&this.documentState===e.documentState&&this.data.isEqual(e.data)}mutableCopy(){return new ye(this.key,this.documentType,this.version,this.readTime,this.createTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {createTime: ${this.createTime}}), {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class di{constructor(e,t,r,i,o){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=i,this.resolvedLimboDocuments=o}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const i=new Map;return i.set(e,nr.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new di(x.min(),i,new re(H),_t(),j())}}class nr{constructor(e,t,r,i,o){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=i,this.removedDocuments=o}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new nr(r,t,j(),j(),j())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $p{constructor(){this.changes=new fn(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,ye.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const r=this.changes.get(t);return r!==void 0?S.resolve(r):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hp{constructor(){this.sessionToken=de.EMPTY_BYTE_STRING}getSessionToken(e){return S.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,S.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zs{constructor(){this.Tr=new he(ce.Er),this.dr=new he(ce.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,t){const r=new ce(e,t);this.Tr=this.Tr.add(r),this.dr=this.dr.add(r)}Rr(e,t){e.forEach(r=>this.addReference(r,t))}removeReference(e,t){this.Vr(new ce(e,t))}mr(e,t){e.forEach(r=>this.removeReference(r,t))}gr(e){const t=new N(new Z([])),r=new ce(t,e),i=new ce(t,e+1),o=[];return this.dr.forEachInRange([r,i],a=>{this.Vr(a),o.push(a.key)}),o}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){const t=new N(new Z([])),r=new ce(t,e),i=new ce(t,e+1);let o=j();return this.dr.forEachInRange([r,i],a=>{o=o.add(a.key)}),o}containsKey(e){const t=new ce(e,0),r=this.Tr.firstAfterOrEqual(t);return r!==null&&e.isEqual(r.key)}}class ce{constructor(e,t){this.key=e,this.wr=t}static Er(e,t){return N.comparator(e.key,t.key)||H(e.wr,t.wr)}static Ar(e,t){return H(e.wr,t.wr)||N.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wp{constructor(e,t){this.indexManager=e,this.referenceDelegate=t,this.mutationQueue=[],this.Sr=1,this.br=new he(ce.Er)}checkEmpty(e){return S.resolve(this.mutationQueue.length===0)}addMutationBatch(e,t,r,i){const o=this.Sr;this.Sr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const a=new gp(o,t,r,i);this.mutationQueue.push(a);for(const l of i)this.br=this.br.add(new ce(l.key,o)),this.indexManager.addToCollectionParentIndex(e,l.key.path.popLast());return S.resolve(a)}lookupMutationBatch(e,t){return S.resolve(this.Dr(t))}getNextMutationBatchAfterBatchId(e,t){const r=t+1,i=this.vr(r),o=i<0?0:i;return S.resolve(this.mutationQueue.length>o?this.mutationQueue[o]:null)}getHighestUnacknowledgedBatchId(){return S.resolve(this.mutationQueue.length===0?-1:this.Sr-1)}getAllMutationBatches(e){return S.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,t){const r=new ce(t,0),i=new ce(t,Number.POSITIVE_INFINITY),o=[];return this.br.forEachInRange([r,i],a=>{const l=this.Dr(a.wr);o.push(l)}),S.resolve(o)}getAllMutationBatchesAffectingDocumentKeys(e,t){let r=new he(H);return t.forEach(i=>{const o=new ce(i,0),a=new ce(i,Number.POSITIVE_INFINITY);this.br.forEachInRange([o,a],l=>{r=r.add(l.wr)})}),S.resolve(this.Cr(r))}getAllMutationBatchesAffectingQuery(e,t){const r=t.path,i=r.length+1;let o=r;N.isDocumentKey(o)||(o=o.child(""));const a=new ce(new N(o),0);let l=new he(H);return this.br.forEachWhile(h=>{const d=h.key.path;return!!r.isPrefixOf(d)&&(d.length===i&&(l=l.add(h.wr)),!0)},a),S.resolve(this.Cr(l))}Cr(e){const t=[];return e.forEach(r=>{const i=this.Dr(r);i!==null&&t.push(i)}),t}removeMutationBatch(e,t){te(this.Fr(t.batchId,"removed")===0),this.mutationQueue.shift();let r=this.br;return S.forEach(t.mutations,i=>{const o=new ce(i.key,t.batchId);return r=r.delete(o),this.referenceDelegate.markPotentiallyOrphaned(e,i.key)}).next(()=>{this.br=r})}On(e){}containsKey(e,t){const r=new ce(t,0),i=this.br.firstAfterOrEqual(r);return S.resolve(t.isEqual(i&&i.key))}performConsistencyCheck(e){return this.mutationQueue.length,S.resolve()}Fr(e,t){return this.vr(e)}vr(e){return this.mutationQueue.length===0?0:e-this.mutationQueue[0].batchId}Dr(e){const t=this.vr(e);return t<0||t>=this.mutationQueue.length?null:this.mutationQueue[t]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const me="WebChannelConnection";class hg extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const r=t.ssl?"https":"http",i=encodeURIComponent(this.databaseId.projectId),o=encodeURIComponent(this.databaseId.database);this.Do=r+"://"+t.host,this.vo=`projects/${i}/databases/${o}`,this.Co=this.databaseId.database==="(default)"?`project_id=${i}`:`project_id=${i}&database_id=${o}`}get Fo(){return!1}Mo(t,r,i,o,a){const l=Yi(),h=this.xo(t,r.toUriEncodedString());O("RestConnection",`Sending RPC '${t}' ${l}:`,h,i);const d={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(d,o,a),this.No(t,h,d,i).then(p=>(O("RestConnection",`Received RPC '${t}' ${l}: `,p),p),p=>{throw rn("RestConnection",`RPC '${t}' ${l} failed with error: `,p,"url: ",h,"request:",i),p})}Lo(t,r,i,o,a,l){return this.Mo(t,r,i,o,a)}Oo(t,r,i){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+dn}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((o,a)=>t[a]=o),i&&i.headers.forEach((o,a)=>t[a]=o)}xo(t,r){const i=lg[t];return`${this.Do}/v1/${r}:${i}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,t,r,i){const o=Yi();return new Promise((a,l)=>{const h=new sl;h.setWithCredentials(!0),h.listenOnce(ol.COMPLETE,()=>{try{switch(h.getLastErrorCode()){case Nr.NO_ERROR:const p=h.getResponseJson();O(me,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(p)),a(p);break;case Nr.TIMEOUT:O(me,`RPC '${e}' ${o} timed out`),l(new V(P.DEADLINE_EXCEEDED,"Request time out"));break;case Nr.HTTP_ERROR:const w=h.getStatus();if(O(me,`RPC '${e}' ${o} failed with status:`,w,"response text:",h.getResponseText()),w>0){let R=h.getResponseJson();Array.isArray(R)&&(R=R[0]);const C=R==null?void 0:R.error;if(C&&C.status&&C.message){const D=function(k){const z=k.toLowerCase().replace(/_/g,"-");return Object.values(P).indexOf(z)>=0?z:P.UNKNOWN}(C.status);l(new V(D,C.message))}else l(new V(P.UNKNOWN,"Server responded with status "+h.getStatus()))}else l(new V(P.UNAVAILABLE,"Connection failed."));break;default:F()}}finally{O(me,`RPC '${e}' ${o} completed.`)}});const d=JSON.stringify(i);O(me,`RPC '${e}' ${o} sending request:`,i),h.send(t,"POST",d,r,15)})}Bo(e,t,r){const i=Yi(),o=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=ll(),l=cl(),h={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(h.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(h.useFetchStreams=!0),this.Oo(h.initMessageHeaders,t,r),h.encodeInitMessageHeaders=!0;const p=o.join("");O(me,`Creating RPC '${e}' stream ${i}: ${p}`,h);const w=a.createWebChannel(p,h);let R=!1,C=!1;const D=new ug({Io:k=>{C?O(me,`Not sending because RPC '${e}' stream ${i} is closed:`,k):(R||(O(me,`Opening RPC '${e}' stream ${i} transport.`),w.open(),R=!0),O(me,`RPC '${e}' stream ${i} sending:`,k),w.send(k))},To:()=>w.close()}),L=(k,z,q)=>{k.listen(z,W=>{try{q(W)}catch(X){setTimeout(()=>{throw X},0)}})};return L(w,xn.EventType.OPEN,()=>{C||(O(me,`RPC '${e}' stream ${i} transport opened.`),D.yo())}),L(w,xn.EventType.CLOSE,()=>{C||(C=!0,O(me,`RPC '${e}' stream ${i} transport closed`),D.So())}),L(w,xn.EventType.ERROR,k=>{C||(C=!0,rn(me,`RPC '${e}' stream ${i} transport errored:`,k),D.So(new V(P.UNAVAILABLE,"The operation could not be completed")))}),L(w,xn.EventType.MESSAGE,k=>{var z;if(!C){const q=k.data[0];te(!!q);const W=q,X=W.error||((z=W[0])===null||z===void 0?void 0:z.error);if(X){O(me,`RPC '${e}' stream ${i} received error:`,X);const Ie=X.status;let J=function(_){const v=ie[_];if(v!==void 0)return Pl(v)}(Ie),E=X.message;J===void 0&&(J=P.INTERNAL,E="Unknown error status: "+Ie+" with message "+X.message),C=!0,D.So(new V(J,E)),w.close()}else O(me,`RPC '${e}' stream ${i} received:`,q),D.bo(q)}}),L(l,al.STAT_EVENT,k=>{k.stat===hs.PROXY?O(me,`RPC '${e}' stream ${i} detected buffering proxy`):k.stat===hs.NOPROXY&&O(me,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{D.wo()},0),D}}function Xi(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qr{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Qr(de.fromBase64String(e))}catch(t){throw new V(P.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new Qr(de.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nm{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new V(P.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new V(P.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return H(this._lat,e._lat)||H(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Yr(n){var e;const t=n.auth,r=await n.getIdToken(),i=await Xn(n,hu(t,{idToken:r}));M(i==null?void 0:i.users.length,t,"internal-error");const o=i.users[0];n._notifyReloadListener(o);const a=!((e=o.providerUserInfo)===null||e===void 0)&&e.length?du(o.providerUserInfo):[],l=km(n.providerData,a),h=n.isAnonymous,d=!(n.email&&o.passwordHash)&&!(l!=null&&l.length),p=h?d:!1,w={uid:o.localId,displayName:o.displayName||null,photoURL:o.photoUrl||null,email:o.email||null,emailVerified:o.emailVerified||!1,phoneNumber:o.phoneNumber||null,tenantId:o.tenantId||null,providerData:l,metadata:new bs(o.createdAt,o.lastLoginAt),isAnonymous:p};Object.assign(n,w)}async function Pm(n){const e=be(n);await Yr(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function km(n,e){return[...n.filter(r=>!e.some(i=>i.providerId===r.providerId)),...e]}function du(n){return n.map(e=>{var{providerId:t}=e,r=to(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yc(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(_u(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(pu(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(vu(e))return"Blackberry";if(Iu(e))return"Webos";if(gu(e))return"Safari";if((e.includes("chrome/")||mu(e))&&!e.includes("edge/"))return"Chrome";if(yu(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function pu(n=ve()){return/firefox\//i.test(n)}function gu(n=ve()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function mu(n=ve()){return/crios\//i.test(n)}function _u(n=ve()){return/iemobile/i.test(n)}function yu(n=ve()){return/android/i.test(n)}function vu(n=ve()){return/blackberry/i.test(n)}function Iu(n=ve()){return/webos/i.test(n)}function so(n=ve()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function Vm(n=ve()){var e;return so(n)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function Nm(){return Xh()&&document.documentMode===10}function Eu(n=ve()){return so(n)||yu(n)||Iu(n)||vu(n)||/windows phone/i.test(n)||_u(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tu(n,e=[]){let t;switch(n){case"Browser":t=yc(ve());break;case"Worker":t=`${yc(ve())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${hn}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function c_(n){const e=gn(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}function l_(n,e,t){return Ke(n.app)?Promise.reject(pt(n)):a_(be(n),mn.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&c_(n),r})}function u_(n,e,t,r){return be(n).onIdTokenChanged(e,t,r)}function h_(n,e,t){return be(n).beforeAuthStateChanged(e,t)}function d_(n,e,t,r){return be(n).onAuthStateChanged(e,t,r)}function f_(n){return be(n).signOut()}const Zr="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function P_(n,e){return e?We(e):(M(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class xv{constructor(e){this.app=e}_delete(){return delete zn[this.app.options.appId],Promise.resolve()}}let zn={},Lc=[];const Mc={};let is="dataLayer",Fv="gtag",xc,sh,Fc=!1;function Uv(){const n=[];if(Qc()&&n.push("This is a browser extension environment."),ed()||n.push("Cookies are not available."),n.length>0){const e=n.map((r,i)=>`(${i+1}) ${r}`).join(" "),t=Se.create("invalid-analytics-context",{errorInfo:e});Re.warn(t.message)}}function Bv(n,e,t){Uv();const r=n.options.appId;if(!r)throw Se.create("no-app-id");if(!n.options.apiKey)if(n.options.measurementId)Re.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${n.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw Se.create("no-api-key");if(zn[r]!=null)throw Se.create("already-exists",{id:r});if(!Fc){vv(is);const{wrappedGtag:o,gtagCore:a}=wv(zn,Lc,Mc,is,Fv);sh=o,xc=a,Fc=!0}return zn[r]=Mv(n,Lc,Mc,e,xc,is,t),new xv(n)}function $v(n=Vs()){n=be(n);const e=jt(n,ni);return e.isInitialized()?e.getImmediate():jv(n)}function jv(n,e={}){const t=jt(n,ni);if(t.isInitialized()){const i=t.getImmediate();if(Hn(e,t.getOptions()))return i;throw Se.create("already-initialized")}return t.initialize({options:e})}function qv(n,e,t,r){n=be(n),Nv(sh,zn[n.app.options.appId],e,t,r).catch(i=>Re.error(i))}const Uc="@firebase/analytics",Bc="0.10.8";function Kv(){Ue(new Oe(ni,(e,{options:t})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("installations-internal").getImmediate();return Bv(r,i,t)},"PUBLIC")),Ue(new Oe("analytics-internal",n,"PRIVATE")),Pe(Uc,Bc),Pe(Uc,Bc,"esm2017");function n(e){try{const t=e.getProvider(ni).getImmediate();return{logEvent:(r,i,o)=>qv(t,r,i,o)}}catch(t){throw Se.create("interop-component-reg-failed",{reason:t})}}}Kv();const zv={apiKey:"AIzaSyBoPbWqksM2RmZTD1x3-ykWUVZzfXlM2d8",authDomain:"kmppampalogs.firebaseapp.com",projectId:"kmppampalogs",storageBucket:"kmppampalogs.firebasestorage.app",messagingSenderId:"672982424982",appId:"1:672982424982:web:5c819788e0c33ba54f91b7",measurementId:"G-NS0X4WSHV4"},mo=tl(zv);$v(mo);const $c=Zg(mo),_o=Ay(mo);class Hv{constructor(e={}){this.rendimiento=e.rendimiento||58.5,this.precioVivo=e.precioVivo||5050,this.distancia=e.distancia||0,this.porcentajeIIBB=e.porcentajeIIBB||1.7,this.jaulaDobleOrSimple=e.jaulaDobleOrSimple??!0,this.pesoJaulaDoble=e.pesoJaulaDoble||21500,this.pesoJaulaSimple=e.pesoJaulaSimple||15500,this.margenGanancia=e.margenGanancia||1.1,this.precioKmSimple=e.precioKmSimple||2500,this.precioKmDouble=e.precioKmDouble||3100}get precioKm(){return this.jaulaDobleOrSimple?this.precioKmDouble:this.precioKmSimple}get kgVivos(){return this.jaulaDobleOrSimple?this.pesoJaulaDoble:this.pesoJaulaSimple}get kgFaena(){return this.kgVivos*(this.rendimiento/100)}get costoInicialPorKgCarne(){return this.rendimiento>0?this.precioVivo/(this.rendimiento/100):0}get costoFletePorKgCarne(){return this.kgFaena>0?this.distancia*this.precioKm/this.kgFaena:0}get costoFinal(){const e=this.costoInicialPorKgCarne+this.costoFletePorKgCarne,r=1-this.margenGanancia*(this.porcentajeIIBB/100);return r>1e-4?e/r:e}get facturaVentaPorKgCarne(){return this.costoFinal*this.margenGanancia}get costoIIBB(){return this.facturaVentaPorKgCarne*(this.porcentajeIIBB/100)}get utilidadPorKg(){return this.facturaVentaPorKgCarne-this.costoFinal}get totalVentaEstimada(){return this.facturaVentaPorKgCarne*this.kgFaena}get utilidadTotalEstimada(){return this.utilidadPorKg*this.kgFaena}}async function oh(n,e,t){if(!e)throw new Error("UID is required to fetch user data");const r=Xg(n,"users",e),i=Yg(r,t);return(await fm(i)).docs.map(a=>{const l=a.data();try{return l.data&&typeof l.data=="string"?{...JSON.parse(l.data),firebaseId:a.id}:{id:a.id,...l}}catch(h){return console.warn(`Error parsing data for ${t} id ${a.id}:`,h),{id:a.id,...l}}})}async function Wv(n,e){return oh(n,e,"travels")}async function Gv(n,e,t){return(await oh(n,e,"master_data")).filter(i=>i.type===t)}function Q(n,{classes:e=[],text:t="",html:r="",attrs:i={}}={}){const o=document.createElement(n);e.length&&o.classList.add(...e),t&&(o.textContent=t),r&&(o.innerHTML=r);for(const[a,l]of Object.entries(i))o.setAttribute(a,l);return o}function ss(n,e,t){return Q("div",{classes:["stat-card"],html:`<div class="stat-icon">${t}</div><div class="stat-info"><p>${n}</p><h3>${e}</h3></div>`})}function Qv(n,e){const{data:t,totalItems:r,currentPage:i,itemsPerPage:o,currentFilter:a,currentSort:l,onFilter:h,onSort:d,onPage:p,categories:w=[],selectedCategory:R,includeCommission:C,onCategoryChange:D,onCommissionToggle:L,categoryStats:k={avgPrice:0,totalKg:0,travelCount:0}}=e;n.innerHTML="";const z=Q("div",{classes:["category-stats-container"]}),q=Q("div",{classes:["selector-row"]}),W=Q("span",{text:"Categorías:",classes:["selector-label"]}),X=Q("div",{classes:["category-chips-container"]});w.forEach(y=>{const m=y==="TODOS"?e.selectedCategories.length===0:e.selectedCategories.includes(y),ae=Q("button",{classes:["category-chip",m?"active":"inactive"],text:y});ae.onclick=()=>e.onCategoryToggle(y),X.appendChild(ae)});const Ie=Q("label",{classes:["comm-toggle"],html:`
  ...
  `});Ie.querySelector("input").onchange=y=>L(y.target.checked),q.appendChild(W),q.appendChild(X),q.appendChild(Ie),z.appendChild(q),e.selectedCategories.length>0;{const y=e.selectedCategories.length===0?"Totales":e.selectedCategories.join(", "),I=Q("div",{classes:["stats-grid"]});I.appendChild(ss(`Precio Prom. [${y}]`,`$${k.avgPrice.toFixed(2)}`,"💰")),I.appendChild(ss("Kg Totales (Finalizados)",`${k.totalKg.toLocaleString()} kg`,"⚖️")),I.appendChild(ss("Viajes Incluidos",`${k.travelCount}`,"🚛")),z.appendChild(I)}n.appendChild(z);const J=Q("div",{classes:["toolbar"]}),E=Q("div",{classes:["filter-group"]});["TODOS","ACTIVO","BORRADOR"].forEach(y=>{const I=Q("button",{classes:["filter-btn",a===y?"active":"none"],text:y});I.onclick=()=>h(y),E.appendChild(I)});const g=Q("button",{classes:["sort-toggle"],html:`📅 Fecha ${l==="DESC"?"▼":"▲"}`});g.onclick=()=>d(l==="DESC"?"ASC":"DESC"),J.appendChild(E),J.appendChild(g),n.appendChild(J);const _=Q("div",{classes:["card-list"]});t.forEach(y=>{var se,ur,Xe,hr,Tt;const I=y.buy||{},m=(se=I.agent)==null?void 0:se.name,ae=Q("div",{classes:["card","travel-card-full"]}),vt=I.agentCommissionAmount||0,Ti=I.totalOperation||0,It=I.totalOperationWithCommission||0,Et=I.generalYield||0;ae.innerHTML=`
    ...
    `;const lr=(I.categories||[]).join(", ")||"N/A",_n=Q("div",{classes:["card-body"]});_n.innerHTML=`
      <div class="grid-2-cols">
        <div class="metrics-column">
          ...
          <div class="detail-row"><span>Precio Prom.:</span> <strong>$${((hr=I.avgPrice)==null?void 0:hr.toFixed(2))||"0.00"}</strong></div>
      ...
      <hr>
    `;const ke=Q("div",{classes:["producers-list"]});(I.listOfProducers||[]).forEach(yn=>{var At;const vn=Q("div",{classes:["producer-item"]});vn.innerHTML=`
      ...
      `;const wt=Q("div",{classes:["product-mini-list"]});(yn.listOfProducts||[]).forEach(Ze=>{const In=Q("div",{classes:["product-mini-row"],html:`
        ...
        `});wt.appendChild(In)}),vn.appendChild(wt),ke.appendChild(vn)}),_n.appendChild(ke),ae.appendChild(_n),_.appendChild(ae)}),n.appendChild(_);const v=Math.ceil(r/o);if(v>1){const y=Q("div",{classes:["pagination"]}),I=Q("button",{classes:["page-btn"],text:"Anterior",attrs:i===1?{disabled:""}:{}});I.onclick=()=>p(i-1);const m=Q("button",{classes:["page-btn"],text:"Siguiente",attrs:i===v?{disabled:""}:{}});m.onclick=()=>p(i+1);const ae=Q("span",{classes:["page-info"],text:`Página ${i} de ${v}`});y.appendChild(I),y.appendChild(ae),y.appendChild(m),n.appendChild(y)}}function Jv(n){const e=Q("div",{classes:["simulator-wrapper"]}),t=Q("div",{classes:["simulator-form","glass-card"]});t.innerHTML=`
