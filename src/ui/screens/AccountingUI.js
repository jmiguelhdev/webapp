...
export function renderAccounting(container, options) {
  ...
  container.appendChild(buildHeader({ title, filteredEntries, entries, clients, producers, establishments, onSave, onExport, title }));
...
function buildHeader({ title, filteredEntries, entries, clients, producers, establishments, onSave, onExport }) {
  const header = el('div', {
